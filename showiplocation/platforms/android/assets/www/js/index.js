...
var bindEvents = function() {
    ...
    document.getElementById("ipLocationRaw").addEventListener("click",function() {makeRestRequest("raw")}, false);
    /*
      add the func call for xml and json 
    */
    document.getElementById("ipLocationJSon").addEventListener("click", function() {makeRestRequest("json")}, false);
    document.getElementById("ipLocationXML").addEventListener("click", function() { makeRestRequest("xml")}, false);


    document.getElementById("soapDictService").addEventListener("click",function() {soapDictService() }, false);
}
